%{!?_pkgdocdir: %global _pkgdocdir /usr/share/doc/%{name}-%{version}/}
...
Patch0001: 0001-Correct-prefix.patch
...
%changelog
* Thu Nov 26 2015 Jeroen van Meeuwen <vanmeeuwen@kolabsys.com> - 0.10.40-1
- Update sometimes, will you?
