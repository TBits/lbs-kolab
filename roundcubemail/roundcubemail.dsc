...
Build-Depends: composer, cssmin, node-uglify, debhelper (>= 8), psa | bash
Package-List:
 roundcubemail deb web extra
 roundcubemail-core deb web extra
Files:
 00000000000000000000000000000000 0 roundcubemail-1.3.0.34.tar.gz
