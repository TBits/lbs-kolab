...
Build-Depends: debhelper (>= 8), roundcubemail-core (>= 1.4), node-less (>= 1.7.0)
Package-List:
 roundcubemail-plugin-contextmenu deb web extra
Files:
 00000000000000000000000000000000 0 roundcubemail-plugin-contextmenu-3.0-rc2.tar.gz
