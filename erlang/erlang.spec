...
#!BuildIgnore:  systemd
%if 0%{?rhel} > 6
#!BuildIgnore:  java-1.7.0-openjdk-devel
%global java_devel java-1.8.0-openjdk-devel
%else
#!BuildIgnore:  java-1.5.0-openjdk-devel
%global java_devel java-1.6.0-openjdk-devel
%endif
%global java_devel_nx86 java-1.5.0-gcj-devel
%else
%global java_devel java-devel
%global java_devel_nx86 java-devel
%endif
...
CFLAGS="$RPM_OPT_FLAGS -mcpu=ultrasparc -fno-strict-aliasing" ; export CFLAGS
%configure \
    --enable-shared-zlib \
    --enable-sctp \
%if 0%{?with_systemd}
