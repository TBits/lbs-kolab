...
%else
Obsoletes: %{name}-ic%{?_isa} < %{version}-%{release}
Provides: %{name}-ic%{?_isa} = %{version}-%{release}
%endif %{__with_java}
Requires: %{name}-inets%{?_isa} = %{version}-%{release}
%if %{__with_java}
Requires: %{name}-jinterface%{?_isa} = %{version}-%{release}
%else
Obsoletes: %{name}-jinterface%{?_isa} < %{version}-%{release}
Provides: %{name}-jinterface%{?_isa} = %{version}-%{release}
%endif %{__with_java}
...
Requires: %{name}-gs%{?_isa} = %{version}-%{release}
%else
Obsoletes: %{name}-gs%{?_isa} < %{version}-%{release}
Provides: %{name}-gs%{?_isa} = %{version}-%{release}
%endif %{__with_tcltk}
Requires: %{name}-kernel%{?_isa} = %{version}-%{release}
Requires: %{name}-public_key%{?_isa} = %{version}-%{release}
Requires: %{name}-sasl%{?_isa} = %{version}-%{release}
...
CFLAGS="${ERL_FLAGS}" CXXFLAGS="${ERL_FLAGS}" %configure --enable-shared-zlib --enable-sctp \
%if 0%{?with_systemd}
    --enable-systemd \
%endif
...
%changelog
* Wed Feb  8 2017 Jeroen van Meeuwen <vanmeeuwen@kolabsys.com> - 19.2.1-1
- Ver. 19.2.1

* Tue Nov 22 2016 Jeroen van Meeuwen <vanmeeuwen@kolabsys.com> - 19.1.6-1
- Ver. 19.1.6
